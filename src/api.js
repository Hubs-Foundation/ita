...
function create() {
  ...
  const cloudFormation = new CloudFormation({ credentialProvider, region: process.env.AWS_REGION });
  const parameterStore = new ParameterStore({ credentialProvider, region: process.env.AWS_REGION });
